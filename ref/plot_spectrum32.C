...
void plot_spectrum32(void)
{
  ...
  // filename here
  sprintf(filename, "ADC_r0000_000.dat");
  ...
  TH1D* hmid = new TH1D("mid", "", 10, 0, 10);
...
fprintf(stdout, "data[10] 0x%x, %d\n",data[10],data[10]);
      sid = data[10] & 0b00100000;
//      mid = data[10] & 0b00011111;
      mid = data[10] & 0x1F;
cout << "sid = " << sid << endl;
cout << "mid = " << mid << endl;
	  hmid->Fill(mid);

fprintf(stdout, "data[11] 0x%x\n",data[11]);
      ch = data[11] & 0xFF;
cout << "ch = " << ch << endl;
